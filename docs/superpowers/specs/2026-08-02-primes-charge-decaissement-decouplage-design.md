...
**R4 · Rattrapage de charge (plafonné).** Si une date de charge théorique (R2) tombe dans un mois déjà clos :
- si le **mois de décaissement de la prime est lui aussi clos** : ne rien écrire côté charge (le réel Qonto le porte déjà, cf. §5 Option B) · éviter le double compte ;
- sinon, reporter la charge au dernier mois du trimestre courant ouvert, **sans jamais franchir la frontière d'exercice** et **sans jamais dépasser le mois de décaissement**. Ce plancher dynamique **remplace** la constante `PRIMES_PLANCHER = '2026-10'` (supprimée). R4 ne s'applique **qu'à l'exercice courant** (un backfill d'un exercice clos garde la date théorique).
