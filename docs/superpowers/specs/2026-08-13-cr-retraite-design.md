...
1. **Rectifier la description de l'immo « Outil simapro »** : la lettre du 2026-07-24 la décrit comme « logiciel acquis servant à la R&D » ; en réalité elle porte les coûts de développement interne d'un outil greffé en amont/aval de SimaPro (précision utilisateur du 2026-08-13, la contradiction avec les 5 quote-parts de salaires est levée). Rectifier auprès du cabinet, car sa réponse A/B en dépend directement ; préciser au passage où est comptabilisée la licence SimaPro elle-même (abonnement en charges ? immobilisation acquise distincte ?).
2. **Assiette CII/CIR par actif** : confirmer PAR ÉCRIT la méthode par actif (A dépenses engagées, celle que Pilot applique aujourd'hui). La lettre du 24/07 posait la question A ou B au cabinet ; aucune réponse n'est tracée dans le repo. Si le cabinet a déjà tranché (A partout), une trace écrite suffit et la question tombe ; la garde B.4 du code reste en veille dans tous les cas.
